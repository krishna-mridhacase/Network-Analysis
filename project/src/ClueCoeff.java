...
public class ClueCoeff {
    ...
    private static double getClusteringCoeff(Graph<String, DefaultEdge> graph) {
ClusteringCoefficient<String, DefaultEdge> clusteringCoeffCalculator = new ClusteringCoefficient<String, DefaultEdge>(graph);
return clusteringCoeffCalculator.getAverageClusteringCoefficient();
